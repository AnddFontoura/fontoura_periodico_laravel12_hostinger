    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    <a
                        :href="route('control-panel.pages.create')"
                    >
                        <button
                            type="button"
                            class="
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <table class="relative min-w-full divide-y divide-gray-300 dark:divide-white/15">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-gray-200 dark:divide-white/10 dark:bg-gray-900">
                                <tr v-for="page in pages.data" :key="page.id" class="even:bg-gray-50 dark:even:bg-gray-800/50">
                                    <td
                                        class="
                                            py-4
                                            pr-3
                                    ...
                                    <td class="py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-3">
                                        <a :href="route('control-panel.pages.edit', page.id)">
                                            <button
        ...
        confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = route('control-panel.pages.delete', id)
                    let method = 'delete'
